  ...
  subroutine src2_bous(meqn,mbc,mx,my, &
      ...
      real(kind=8) dx,dy,xlower,ylower, dx2, dy2
...
!      Boussinesq type-------------------------------------------------
     ...
     if (coordinate_system == 2) then
        dx2 = dx*111.32d3*cos((ylower + dy*my/2.)/180.d0*3.1415926d0)
        dy2 = dy*110.574d3
     else
        dx2 = dx
        dy2 = dy
     ...
     nstep=ceiling(max(dt/dx2,dt/dy2)*2*sqrt(2.))
     ...
     do ii=1,nstep
        ...
        do i=1,mx
          ...
          call read_diag(my,meqn,mbc,dy2,q1d,maux,aux1d, DL, D, DU)
          ...
          call read_psi(my,meqn,mbc,dy2,q0,maux,aux1d,psi,g)
...
!=======================================================================
        ...
        do j=1,my
          ...
          call read_diag(mx,meqn,mbc,dx2,q1d,maux,aux1d, DL, D, DU)
          ...
          call read_psi(mx,meqn,mbc,dx2,q0,maux,aux1d,psi,g)
