...
tauy_i = 10000      # initial yield strength (Pa)
...
if (remolding):
    tauy_r = 500
    fname = "../tmp/remold_init.tt3"
    if os.path.isfile(fname):
       fname_remold = os.path.abspath(os.path.join(os.getcwd(), fname))
...
#------------------------------
    ...
    probdata.add_param('fname_remold',  fname_remold,'Initial condition of Remolding')
